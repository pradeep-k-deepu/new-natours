...
var getMap = function getMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJhZGVlcC1rLWRlZXB1IiwiYSI6ImNrcnE0YWh3MDA0eW8ycW8waGowOWtvZ2cifQ.D20I95BYzr3u99xEwPyrRA';
...
function updateUserData(_x, _x2) {
  return _updateUserData.apply(this, arguments);
}

function _updateUserData() {
  _updateUserData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, data) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            console.log(data);
            type === 'data' ? url = 'http://localhost:3000/api/v1/users/updateMe' : url = 'http://localhost:3000/api/v1/users/updateMyPassword';
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JLIdwSHRlMWHn5YkaHokKEeyuOLDpXicl7ALolkCqlrJy0slChuhR48o74FXIijvyJcKLW4NZy7Vtpt3f4F9mGD00J2mKCTQ8');
            _context.next = 4;
...
var updateSettings = document.querySelector('.form-user-settings');
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateUserData)('data', userData);
  });
}
...
if (updateSettings) {
  updateSettings.addEventListener('submit', function (e) {
    ...
    (0, _updateUserData.updateUserData)('password', {
